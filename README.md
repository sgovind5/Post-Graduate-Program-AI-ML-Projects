# Post-Graduate-Program-AI-ML-Projects
Projects completed as a part of Great Learning UT Austin PGP - Artificial Intelligence and Machine Learning Course
-------------------------------------------------------------------------------------------------------------------
...
### 2. SuperKart: Predictive Revenue Forecasting & MLOps Pipeline
...
### 3. HelmNet: Automated HSE Computer Vision Monitoring
...
### 4. ReneWind: Predictive Maintenance for Industrial Asset Optimization
...
## 📊 Core Data Science & Predictive Analytics Foundations

### 5. EasyVisa: Ensemble Modeling for Operational Risk Mitigation
...
### 6. Personal Loan Campaign: Propensity Modeling for Targeted Marketing
...
### 7. FoodHub: Demand-Side Exploratory Data Analysis
...
## 🛠️ Technology Blueprint Summary

| Focus Area | Technologies & Methods |
| --- | --- |
| **Generative AI & Architecture** | Retrieval-Augmented Generation (RAG), Prompt Engineering, Context Windows |
| **MLOps & Cloud Infrastructure** | Docker, Flask, Streamlit, HuggingFace Spaces, REST APIs |
| **Deep Learning & CV** | Convolutional Neural Networks (CNNs), Transfer Learning, Neural Networks |
| **Ensemble & Classic ML** | Stacking, Boosting, Bagging, Decision Trees, Hyperparameter Optimization |
| **Data Engineering Foundations** | Python, Pandas, NumPy, Seaborn, Exploratory Data Analysis (EDA) |
